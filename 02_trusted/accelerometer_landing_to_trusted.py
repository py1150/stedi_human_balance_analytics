...
customer_trusted_node1711991840954 = glueContext.create_dynamic_frame.from_catalog(database="stedi", table_name="customer_trusted", transformation_ctx="customer_trusted_node1711991840954")
...
;
'''
accelerometer_landing_to_trusted_node1711991905927 = sparkSqlQuery(glueContext, query = SqlQuery0, mapping = {"customer_trusted":customer_trusted_node1711991840954, "accelerometer_landing":accelerometer_landing_node1711991778048}, transformation_ctx = "accelerometer_landing_to_trusted_node1711991905927")
